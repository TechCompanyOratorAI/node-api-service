...
class GroupService {
    async createGroup(classId, groupName, description, userId) {
        try {
            ...
            if (existingMembership) {
                return { success: false, message: 'Bạn đã thuộc một nhóm trong lớp này' };
            }
            ...
            return { success: false, message: 'Không thể tạo nhóm', error: error.message };
        }
    }
    ...
    async joinGroup(groupId, userId) {
        try {
            ...
            const enrollment = await Enrollment.findOne({
                where: { studentId: userId, classId: group.classId, status: 'enrolled' }
            });
            ...
            return { success: false, message: 'Không thể tham gia nhóm', error: error.message };
        }
    }
    ...
    async leaveGroup(groupId, userId) {
        try {
            ...
            if (membership.role === 'leader') {
                return {
                    success: false,
                    message: 'Bạn là trưởng nhóm. Vui lòng chuyển quyền trưởng nhóm hoặc giải thể nhóm trước khi rời đi'
                };
            }
            ...
            return { success: false, message: 'Không thể rời nhóm', error: error.message };
        }
    }
    ...
    async removeMember(groupId, studentId, userId) {
        try {
            ...
            if (!leaderMembership || leaderMembership.role !== 'leader') {
                return { success: false, message: 'Chỉ trưởng nhóm mới có quyền xóa thành viên' };
            }
            ...
            return { success: false, message: 'Không thể xóa thành viên', error: error.message };
        }
    }
    ...
    async promoteMember(groupId, studentId, userId) {
        try {
            ...
            if (!currentLeader || currentLeader.role !== 'leader') {
                return { success: false, message: 'Chỉ trưởng nhóm mới có quyền chuyển quyền' };
            }
            ...
            return { success: false, message: 'Không thể chuyển quyền', error: error.message };
        }
    }
    ...
    async updateGroup(groupId, updateData, userId) {
        try {
            ...
            if (!leader) {
                return { success: false, message: 'Chỉ trưởng nhóm mới có quyền cập nhật' };
            }
            const group = await Group.findByPk(groupId);
            if (!group) {
                return { success: false, message: 'Nhóm không tồn tại' };
            ...
            return { success: false, message: 'Không thể cập nhật nhóm', error: error.message };
        }
    }
    ...
    async deleteGroup(groupId, userId) {
        try {
            ...
            if (!leader) {
                return { success: false, message: 'Chỉ trưởng nhóm mới có quyền giải thể nhóm' };
            }
            ...
            return { success: false, message: 'Không thể giải thể nhóm', error: error.message };
        }
    }
    ...
    async getGroupsByClass(classId, userId) {
        try {
            ...
            return { success: false, message: 'Không thể lấy danh sách nhóm', error: error.message };
        }
    }
    ...
    async getGroupById(groupId, userId) {
        try {
            ...
            return { success: false, message: 'Không thể lấy thông tin nhóm', error: error.message };
        }
    }
        ...
        try {
            const groups = await Group.findAll({
                include: [{
                    ...
                    model: Class,
                    as: 'class',
                    attributes: ['classId', 'className', 'courseId']
                }]
            });
            ...
            return { success: false, message: 'Không thể lấy danh sách nhóm của bạn', error: error.message };
        }
    }
}
