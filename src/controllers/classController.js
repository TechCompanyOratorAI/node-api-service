    ...
    async getClassById(req, res) {
        try {
            ...
            if (result.success) {
                ...
                const status = result.message === 'Bạn không có quyền truy cập lớp học này' ? 403 : 404;
    ...
    async updateClass(req, res) {
        try {
            ...
            if (result.success) {
                ...
                const status = result.message === 'Bạn không có quyền truy cập lớp học này' ? 403 : 400;
                return res.status(status).json(result);
            }
        } catch (error) {
